    ...
    >
      ...
      <li className="">
        ...
        <div className="flex flex-col gap-4 px-4">
          ...
          <img
            src="/assets/guide/photo_5454109623104695287_y.jpg"
            alt=""
            className="object-cover w-full h-full"
          />
        </div>
