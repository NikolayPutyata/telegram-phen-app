...
const GoldCol = () => {
  ...
  <div className='grid grid-cols-2 gap-2 rounded-3xl'>
    <div className='bg-red-50 rounded-3xl  border-1 border-amber-400  overflow-hidden'><img src="https://res.cloudinary.com/dv1acgeyp/image/upload/v1740682426/comandor_1_1_11zon_oxopsf.webp" alt="" className='object-cover w-full h-full'/></div>
    <div className='bg-red-50 rounded-3xl  border-1 border-amber-400 overflow-hidden'><img src="https://res.cloudinary.com/dv1acgeyp/image/upload/v1740682664/planet_4_11_11zon_ufeya7.webp" alt="" className='object-cover w-full h-full'/></div>
        </div>
        <div className={`${s.font} flex justify-center text-lg gap-3`}> <span className='flex justify-center items-center gap-1'><div className='flex items-center justify-center'>420</div><img
                ...
                width={'20px'}
                height={'25px'}
              /></span> <div className='flex items-center justify-center text-gray-400 text-sm'>+ 20%</div></div>
        <div className='flex flex-col justify-center items-center'>
       <button className="btn btn-primary w-full rounded-4xl self-center bg-gradient-to-r from-blue-500 to-purple-500 animate-gradient">Claim</button>
      </div>
      </div>
