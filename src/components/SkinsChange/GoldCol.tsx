...
const GoldCol = () => {
  ...
  <div className='bg-red-700 col-span-2 rounded-3xl border-1 border-amber-400 overflow-hidden h-44'><img src="https://res.cloudinary.com/dv1acgeyp/image/upload/v1740682767/shut_11zon_g5onzi.webp" alt="" className='object-cover w-full h-full'/></div>
  <div className='bg-red-300 rounded-3xl border-1 border-amber-400 overflow-hidden'><img src="https://res.cloudinary.com/dv1acgeyp/image/upload/v1740926028/gold_station_clq1ri.webp" alt="" className='object-cover w-full h-full'/></div>
