  ...
  return (
    <div>
      <div className=" rounded-3xl mx-4 grid grid-cols-2 gap-4">
        <div className=" col-span-2 rounded-3xl border-1 border-gray-700 overflow-hidden h-44">
          <img
        ...
        <div className="rounded-3xl border-1 border-gray-700 overflow-hidden">
          <img
            src="https://res.cloudinary.com/dv1acgeyp/image/upload/v1742288292/baseBase_11zon_a7myfo.webp"
            alt=""
            className="object-cover w-full h-full"
          />
        </div>
        <div className="grid grid-cols-2 gap-2 rounded-3xl">
          <div className="bg-red-50 rounded-3xl text-black border-1 border-gray-700  overflow-hidden">
            <img
              src="https://res.cloudinary.com/dv1acgeyp/image/upload/v1741770392/basic_comandor_11zon_viuhlg.webp"
              alt=""
              className="object-cover w-full h-full"
            />
          </div>
